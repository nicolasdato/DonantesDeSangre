...
public class BusquedaTest {
	...
	public void busquedaTest() {
		...
		assertFalse(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeRecibirDe(new ORhNFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, new BusquedaLocalidad("Localidad", new BusquedaProvincia("Provincia", new BusquedaEdadMayorA(10, null))));
		assertTrue(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeRecibirDe(new ARhNFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, null);
		assertTrue(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeRecibirDe(new ORhPFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, null);
		assertTrue(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeRecibirDe(new BRhPFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, null);
		assertFalse(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeRecibirDe(new ABRhPFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, null);
		assertFalse(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeDonarA(new ABRhPFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, null);
		assertTrue(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeDonarA(new ARhPFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, null);
		assertTrue(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeDonarA(new ARhNFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, null);
		assertFalse(busqueda.acepta(persona));
		busqueda = new BusquedaPuedeDonarA(new ORhNFactory().crearSangre(), Donacion.TipoDonacion.GLOBULOS_ROJOS, null);
		assertFalse(busqueda.acepta(persona));
